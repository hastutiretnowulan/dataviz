...
```
    ...
    ## Observations: 1,394
    ## Variables: 14
    ## $ province                             <chr> "Bali", "Bali", "Bali", "Ba…
    ## $ year                                 <dbl> 1976, 1977, 1978, 1979, 198…
    ## $ population                           <dbl> NA, NA, NA, NA, NA, NA, NA,…
    ## $ agriculture                          <dbl> 1220349, 1472457, 1401453, …
    ## $ construction                         <dbl> 233895.9, 288946.0, 285614.…
    ## $ financial_service                    <dbl> 139543.0, 144087.8, 155384.…
    ## $ manufacturing                        <dbl> 108989.4, 126902.2, 161649.…
    ## $ mining_and_quarrying                 <dbl> 44651.11, 52782.11, 62116.0…
    ## $ other_service                        <dbl> 484730.6, 508151.6, 524712.…
    ## $ trade_hotel_and_restaurant           <dbl> 398117.3, 499387.9, 606147.…
    ## $ transportation_and_telecommunication <dbl> 205046.5, 234600.9, 261713.…
    ## $ utilities                            <dbl> 3308.478, 4619.913, 4967.28…
    ## $ total_gdp_excluding_oil_and_gas      <dbl> NA, NA, NA, NA, NA, NA, NA,…
...
```
    ...
    ## Reading layer `OGRGeoJSON' from data source `/Users/hastutiretnowulan/dataviz/data-raw/states_provinces.json' using driver `GeoJSON'
...
```
    ...
    ## $ electricity_total           <dbl> 89.36, 55.30, 85.57, 99.24, 48.28, 8…
    ## $ fixed_line_phone_connection <dbl> 5.284394, 3.857858, 2.023558, 24.317…
    ## $ safe_sanitation             <dbl> 48.26, 48.09, 57.17, 75.80, 52.83, 4…
    ## $ safe_water                  <dbl> 55.83, 21.10, 36.59, 58.35, 25.15, 3…
